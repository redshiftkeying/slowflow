...
// gl Views -pages
import Templet from '@/views/gl/Templet'
import Sheet1 from '@/views/gl/Sheet1'
import Sheet2 from '@/views/gl/Sheet2'
import TreeTable from '@/views/gl/TreeTable'
import HtmlPanel from '@/components/HtmlPanel'
import OnlyOffice from '@/views/gl/OnlyOffice'
// Views - Pages
...
export const asyncRouterMap = [

 {
...

   {
    ...
    hidden:false,
    children: [
     {path: '/home1/dashboard',name: '主页',icon:'speedometer',component: _import('Dashboard2')},
     {path: '/gl/templet',name: '报表填写',icon:'social-html5',component: _import('gl/Templet')},
     {path: '/gl/sheet1',name: 'iframe表格展示',icon:'pie-graph',component: _import('gl/Sheet1')},
     {path: '/gl/sheet2',name: 'v-html表格展示',icon:'pie-graph',component: _import('gl/Sheet2')},
     {path: '/gl/treetable',name: '模板管理',icon:'pie-graph',component: _import('gl/TreeTable')},
     {path: '/gl/onlyoffice',name: 'excel演示',icon:'pie-graph',component: _import('gl/OnlyOffice')}
    ]
  },
